...
import {AiFillMediumSquare, AiOutlineTwitter, AiOutlineBook} from "react-icons/ai";
        ...
        <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center'}}>
            <p className={styles.getTokenText} style={{margin: 0}}
               onClick={() => window.open("https://spooky.fi/#/swap?inputCurrency=0x04068DA6C83AFCFA0e13ba15A6696662335D5B75&outputCurrency=" + EASY_ADDRESS, "_blank")}>Buy
                $EASY</p>
            <GiWhiteBook color={"#3a70ed"} size={26} className={styles.navbarIcon}
                           onClick={() => window.open("https://docs.backup.easyblock.finance", "_blank")}/>
